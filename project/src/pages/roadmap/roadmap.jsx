  ...
  <ol>
    ...
    <li>
      ...
      <ul>
        ...
        <li>Библиотеки: tailwind/material ui/ant design (иметь опыт хотя бы с двумя)</li>
      </ul>
    </li>
    <li>
      JavaScript
      <ul>
        <li>Типы данных, переменные, функции, циклы, проверки, логические операторы</li>
        <li>Хостинг</li>
        <li>Функции (в том числе стрелочные)</li>
        <li>Работа с объектами (методы, копирование, this, функции-конструкторы, геттеры-сеттеры, дескрипторы свойств)</li>
        <li>Массивы</li>
